...
var repairableRelations = map[string]string{
	...
	"candidate_assessments": "runs", "timeline_items": "sessions runs", "ai_assessments": "timeline_items sessions",
	"ai_detection_jobs": "sessions", "media_provenance_assessments": "timeline_items sessions",
	...
	"feedback_events": "timeline_items sessions runs", "selection_corrections": "timeline_items sessions runs",
	"semantic_event_reports": "semantic_events timeline_items sessions runs", "semantic_event_deltas": "semantic_events semantic_event_reports",

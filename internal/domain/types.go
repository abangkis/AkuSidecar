...
type AutoUpdateUsageLimitPause struct {
...
type AutoUpdateStatus struct {
	...
	LastAdaptiveOutcome                 string                  `json:"lastAdaptiveOutcome,omitempty"`
	LastAdaptiveOutcomeAt               string                  `json:"lastAdaptiveOutcomeAt,omitempty"`
	LastAdaptiveOutcomeItems            int                     `json:"lastAdaptiveOutcomeItems,omitempty"`
	LastAdaptiveOutcomeTrigger          string                  `json:"lastAdaptiveOutcomeTrigger,omitempty"`
	LastAdaptiveOutcomeCompletedSources int                     `json:"lastAdaptiveOutcomeCompletedSources,omitempty"`
	LastAdaptiveOutcomeFailedSources    int                     `json:"lastAdaptiveOutcomeFailedSources,omitempty"`

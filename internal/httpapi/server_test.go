...
func TestHealthAndBootstrapExposeGoBoundary(t *testing.T) {
	...
	for path, markers := range map[string][]string{
		"/":           {"Semantic event engine", "AI Detector", "AI Detection", "ai-detection-enabled", "Resurfaced content", "resurface-mode", "resurface-cooldown-days", "Reasoning processes", "reasoning-processes", "reasoning-executable-path", "detect-reasoning-executable", "ai-detection-presentation", "timeline-side-pane", "semantic-event-shortlist", "semantic-event-merge-threshold", "reset-semantic-event-merge-threshold", "knowledge-retention-days", "knowledge-storage-limit", "timeline-boundary-follow", "timeline-boundary-return-ms", "onboarding-learning-panel", "MEET AKUBROWSER", "WHAT THIS BUILD ADDS"},
